...
const defaultFeatures: FeatureCard[] = [
  ...
  },
  {
    ...
    description: "High-performance servers ensuring the fastest downloads in record time.",
  ...
  },
  {
    ...
    description: "Just paste the URL, select format, and download. Elegant simplicity at its best.",
  ...
  },
  {
    ...
    description: "Browser-based solution that works instantly. No downloads, no installations.",
  ...
  },
  {
    ...
    description: "Your data stays yours. We never collect, store, or share your information.",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-in-up">
          <div className="inline-block">
            <div className="mb-4">
              <span className="text-slate-500 text-lg font-light tracking-wide">Why Choose Us</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-800 tracking-tight">
              What Makes Us <span className="gradient-text-soft">Special</span>
            </h2>
